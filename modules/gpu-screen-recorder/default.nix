...
in
  with lib; {
    ...
    config = let
      ...
      gsr = pkgs.callPackage ./packages/gpu-screen-recorder.nix {};
      ...
      packages = [
        ...
        #   } ''
        #     mkdir -p $out/bin
        #     makeWrapper ${gsr}/gpu-screen-recorder $out/bin/gpu-screen-recorder \
        ...
        (lib.mkIf (cfg.enable)
          {
            ...
            security.wrappers."gpu-screen-recorder" = lib.mkForce {
              owner = "root";
              group = "root";
              capabilities = "cap_sys_nice+ep";
              source = "${cfg.package}/gpu-screen-recorder";
            };
          })
